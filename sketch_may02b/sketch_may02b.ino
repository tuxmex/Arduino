...
//// INPUTS
const u8   DHTPIN = 2; // DHT sensor input pin
const u8   B1_MAN = 0; // Button-1 input pin
const u8  B2_ALTA = 2; // Button-2 input pin
...
const u8 LED_AUTO   = 13; // LED: Refri Auto output
